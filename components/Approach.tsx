  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        My <span className="gradient-text drop-shadow-lg">My Approach</span>
      </h1>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-yellow rounded-3xl overflow-hidden"
            colors={[[125, 211, 252]]}
          />
        </Card>
      </div>
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center
       dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl bg-slate-900/70"
      style={{
        backgroundColor:
